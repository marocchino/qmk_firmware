 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LCtrl  | A/FN |   S  |   E  |   T  |   G  |------|           |------|   Y  |   N  |   I  |   O  | H/FN | Enter  |
 * |--------+------+------+------+------+------|   -  |           |   =  |------+------+------+------+------+--------|
...
[BASE] = KEYMAP(
        ...
        BRC,          KC_J,    KC_U,    KC_R,    KC_L,    KC_SCLN, KC_BSLS,
                      KC_Y,    KC_N,    KC_I,    KC_O,    MDIA_H,  KC_ENT,
...
/* Keymap 2: Windows Control
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        | Exit | Close|      |Reload| NTab |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | All  | Save | Find |      |      |------|           |------|      |      |      | Loc  |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
